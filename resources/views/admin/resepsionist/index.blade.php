...
<div class="row top_tiles">
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<a class="btn btn-primary" role="button" data-toggle="collapse" href="#collapse-tambah" aria-expanded="false" aria-controls="collapseExample">
			<i class="fa fa-plus"></i> Tambah Data Resepsionist
		</a>
		<div class="collapse" id="collapse-tambah">
			<div class="well">
				<div class="x_panel">
					<div class="x_title">
						<h2>Tambah Data Resepsionist</h2>
							...
							<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
								<div class="col-lg-12">
									<div class="form-group">
										...
										<input type="hidden" name="level"  value="resepsionist">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
							...
							<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="form-group">
											<label></label>
											<img src="{{ URL::to('images/user-resepsionist.jpg') }}" class="img-thumbnail" width="200px" height="200px" id="showPhoto">
											<input type="file" class="form-control" id="photo" name="photo" value="{{ URL::to('images/user-resepsionist.jpg') }}">
										</div>
									</div>
								</div>
							</div>
...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
			<form action="{{ route('updateAdminResepsionist') }}"  method="post" id="frm-edit" enctype="multipart/form-data">
			{{ csrf_field() }}
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group">
				...
				<div class="col-lg-6">
					<div class="form-group">
						<label>Tgl. Lahir</label>
						<input type="text" name="tgl_lahir" id="tgl_lahir" id="datepicker" class="form-control">
					</div>
				</div>
				<div class="col-lg-12">
					<div class="form-group">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		buttons: {
		confirm: function () {
					$.get("{{route('deleteAdminResepsionist')}}", {id:id}, function(data) {
