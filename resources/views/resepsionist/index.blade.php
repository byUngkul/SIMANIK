                ...
                <div class="x_content">
                  ...
                  <div class="">
                    ...
                    <?php $no = 1; ?>
                      ...
                      <li>
                        <p>{{$no++}}.  {{ $data->nama }} ({{ $data->created_at->diffForHumans() }})<a href="#!" class="btn btn-danger btn-xs pull-right btn-hapus" data-toggle="tooltip" title="Hapus Data" data-id="{{ $data['id'] }}"><i class="fa fa-trash"></i></a></p> 
                      </li>
                      @endforeach
                      @else
